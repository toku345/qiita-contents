...
```markdown:.claude/skills/creating-marp-slides/SKILL.md
---
name: marp
...
| スキル | 役割 |
|-------------|------|
| [marp](https://github.com/toku345/marp-slides/blob/main/.claude/skills/creating-marp-slides/SKILL.md) | Marp構文やベストプラクティスの情報を提供 |
